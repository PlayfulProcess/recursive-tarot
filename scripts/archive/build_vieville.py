...
TRUMPS = [
    ...
    ("VII", "La Justice", "Justice — sword and scales — numbered VII. The Viéville keeps the older Eastern order, where Justice sits at 7, not the Marseille-standard 8."),
    ("VIII", "Le Chariot", "The Chariot under its canopy, numbered VIII — the position the Marseille standard gives to Justice."),
    ("VIIII", "La Force", "Strength — the figure mastering the lion — at VIIII (9), its Eastern-order position."),
    ("X", "La Roue de Fortune", "The Wheel of Fortune."),
    ("XI", "L'Hermite", "The Hermit, the cloaked old man — at XI, where the Marseille standard puts Strength."),
