...
- **Easy route — in the app.** Open any card on the [card browser](../viewers/cards.html) and use the **✏️ Edit in recursive.eco** button. It opens the deck in recursive.eco's Create editor — make your change and save; if it isn't your own deck, the edit is proposed to the owner for review. No git, no raw JSON.
...
> **Look for the two purple buttons.** Anywhere you're reading a deck in this site — the [card browser](../viewers/cards.html), the [Caster](../viewers/caster.html) — every card carries two small purple recursive.eco buttons: <span style="white-space:nowrap">▶ **Cast in recursive.eco ↗**</span> (opens the deck in the Journal, ready to draw — for reading, not fixing) and <span style="white-space:nowrap">✏️ **Edit in recursive.eco ↗**</span> (opens the deck in Create — this is the one you want here). The same two buttons, the same wording, mark every card across the whole site — so you learn them once and recognise them everywhere.
