...
| Deck | Era | Open · Edit |
|---|---|---|
| **Sola Busca Tarot** | 1491 | <span class="dlinks"><a class="eco" href="https://flow.recursive.eco/g/277953bc-b745-419a-a265-484865e75516" target="_blank" rel="noopener" title="Open the live grammar on recursive.eco"><img src="../recursive-logo.svg" alt="Open on recursive.eco"></a><a class="gh" href="https://github.com/PlayfulProcess/recursive-tarot/edit/dev/tarot/sola-busca-tarot/grammar.json" target="_blank" rel="noopener" title="Edit the JSON on GitHub"><img src="../course/img/github-mark.svg" alt="Edit on GitHub"></a></span> |
| **Ganjifa** | 16th c.+ | <span class="dlinks"><a class="gh" href="https://github.com/PlayfulProcess/recursive-tarot/edit/dev/tarot/ganjifa/grammar.json" target="_blank" rel="noopener" title="Edit the JSON on GitHub"><img src="../course/img/github-mark.svg" alt="Edit on GitHub"></a></span> |
...
| **The Cary Sheet** | c. 1500 | <span class="dlinks"><a class="gh" href="https://github.com/PlayfulProcess/recursive-tarot/edit/dev/tarot/cary-sheet/grammar.json" target="_blank" rel="noopener" title="Edit the JSON on GitHub"><img src="../course/img/github-mark.svg" alt="Edit on GitHub"></a></span> |
| **The Rosenwald Sheet** | c. 1500 | <span class="dlinks"><a class="gh" href="https://github.com/PlayfulProcess/recursive-tarot/edit/dev/tarot/rosenwald-sheet/grammar.json" target="_blank" rel="noopener" title="Edit the JSON on GitHub"><img src="../course/img/github-mark.svg" alt="Edit on GitHub"></a></span> |
...
| **Jean Noblet Tarot** | c. 1650 | <span class="dlinks"><a class="gh" href="https://github.com/PlayfulProcess/recursive-tarot/edit/dev/tarot/noblet-tarot/grammar.json" target="_blank" rel="noopener" title="Edit the JSON on GitHub"><img src="../course/img/github-mark.svg" alt="Edit on GitHub"></a></span> |
...
2. **Find your deck.** Simplest is the **table above** — click a deck's recursive.eco logo and it opens right there in the app. Or, inside recursive.eco, open **Library** and search it by name. (And anywhere you're reading a deck in this site's [card browser](../viewers/cards.html), each card carries a **View deck on recursive.eco** link straight to it.)
...
![claude.ai → Settings → Connectors → open Customize.](images/mcp-connect-1.png)

![Customize → Connectors → the + (Add connector) button.](images/mcp-connect-2.png)

![The + menu → Add custom connector.](images/mcp-connect-3.png)

![Name it recursive.eco, paste https://flow.recursive.eco/api/mcp, and click Add.](images/mcp-connect-4.png)
