...
- [ ] **TG-TRUMPHL** — on your lead, stop highlighting trumps as if forced; highlight only legal plays per Q-TRUMP-RULE. (E)
...
- [ ] **TG-76** — explain "half of 76" in the UI (see Q-76). (G)
...
- [ ] **SB-BTNS** — "Cast" + "Re-cast" are the same action → just "Cast". (P)
- [ ] **SB-IMPORT** — rename "Import" → "Import Spread". (Q)
